gsap.registerPlugin(ScrollTrigger);//1. Сначала мы регистрируем плагин ScrollTrigger для использования его функционала:

let iteration = 0; //2. Мы инициализируем переменные iteration и spacing, а также создаем функцию snap для плавного позиционирования скролла между слайдами:
